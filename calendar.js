	...
	*/
	...
	if (endDate == null) { 
		Calendar.setup({
			...
			button         :    "f_trigger_b",  // What will trigger the popup of the calendar
			ifFormat       :    "%d-%m-%Y",
			date           :     cal.date,
...
/**
 *  This function creates the calendar staffide the given parent.  If _par is
 *  null than it creates a popup calendar staffide the BODY element.  If _par is
